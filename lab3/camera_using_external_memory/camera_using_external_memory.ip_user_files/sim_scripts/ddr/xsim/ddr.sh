...
#
# Script generated by Vivado on Tue Feb 10 13:59:26 -0800 2026
...
#
# Usage        : ddr.sh
#                ddr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ddr.sh [-reset_run]
#                ddr.sh [-reset_log]
#                ddr.sh [-help]
#
...
# script info
echo -e "ddr.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ddr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr xil_defaultlib.ddr xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ddr.wdb xsim.dir libdpi.so)
...
Usage: ddr.sh [-reset_log]\n\
Usage: ddr.sh [-keep_index]\n\

...
#
# Script generated by Vivado on Tue Feb 10 13:59:41 -0800 2026
...
#
# Usage        : line_buffer.sh
#                line_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                line_buffer.sh [-reset_run]
#                line_buffer.sh [-reset_log]
#                line_buffer.sh [-help]
#
...
# script info
echo -e "line_buffer.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./line_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot line_buffer xil_defaultlib.line_buffer xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb line_buffer.wdb xsim.dir libdpi.so)
...
Usage: line_buffer.sh [-step]\n\
Usage: line_buffer.sh [-lib_map_path]\n\
Usage: line_buffer.sh [-reset_run]\n\
Usage: line_buffer.sh [-reset_log]\n\
Usage: line_buffer.sh [-keep_index]\n\
